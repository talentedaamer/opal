 ...
 * content-none.php
 *
 * Display the no results for content.
 */
?>

<div class="not-found container-404">
	<header class="entry-header">
		<h1><?php _e( 'Nothing Found!', 'opal' ) ?></h1>
	</header>

	<p><?php _e( 'It looks like nothing was found here. Try searching for something else or see the latest posts.', 'opal' ) ?></p>
